...
This is a customize of gatsby-remark-images for amp. I omitted `background-image:url(hogehoge)` for amp.

Because amp needs me to use light weight html tag.

Sometimes img tag generated by gatsby-remark-images is so heavy,

because this embed `background-image:url(hogehoge)` in img tag.

below description is [gatsby-remark-images](https://www.gatsbyjs.org/packages/gatsby-remark-images/)
...
`npm install --save gatsby-remark-images-without-bg gatsby-plugin-sharp`
